...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        lifeline.setBounds(900, 470, 150, 30);
        ...
        submit.setBounds(900, 520, 150, 30);
    ...
    public void paint(Graphics g) {
        ...
        g.setFont(new Font("Bahnschrift SemiBold", Font.BOLD, 20));

        if (timer > 0) {
            g.drawString(time, 870, 410);
        } else {
